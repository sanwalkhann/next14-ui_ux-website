...
export function Cta() {
  return (
    <div className="rounded-[16px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px] w-[80%] mx-auto">
